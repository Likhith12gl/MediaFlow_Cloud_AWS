...
const MenuOptions = ({ className }: Props) => {
  ...
  return (
    <nav
      className={cn(
        "dark:bg-black h-screen overflow-scroll  justify-between flex items-center flex-col  gap-10 py-6 px-2",
        className
      )}
    >
      <div className="flex items-center max-w-[80px] justify-center flex-col gap-8">
        <Link className="flex text-center  font-bold flex-row " href="/">
          Media <br />
          Flow
        </Link>
        <TooltipProvider>
